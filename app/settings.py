...
SECRET_KEY = 'django-insecure-Q#*t0zNGSL%xDT*oi*mHaxoQy4eTjs'
...
ACCOUNT_CONFIRM_EMAIL_ON_GET = True  # Users can confirm email by making a GET request to verification URL
